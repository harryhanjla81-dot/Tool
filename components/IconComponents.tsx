...
export const ShareIcon: React.FC<IconProps> = ({ className = "w-5 h-5", title }) => (
  <svg viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg" className={className}>
    {title && <title>{title}</title>}
    <path fill="currentColor" d="M10 3h-5.1c0 0-4.9 0-4.9 5 0 3.9 3 8 3 8s-1.7-7 1.8-7h5.2v3l6-6-6-6v3z"></path>
  </svg>
);
