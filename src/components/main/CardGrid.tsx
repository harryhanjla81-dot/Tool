...
import { CardData, NewsArticle, ViralPost, CardStyleSettings } from '../../../types.ts';
...
interface CardGridProps {
    ...
    onDownloadCard: (article: NewsArticle) => void;
    onGenerateAiImage: (id: string) => void;
    onUploadImage: (id: string, file: File) => void;
    onEditCard: (id: string) => void;
    onDownloadViralPost: (post: ViralPost) => void;
                ...
                <div key={card.id} data-card-id={card.id}>
                    {card.type === 'news' ? (
                        <NewsCard
                            ...
                            onStyleChange={onUpdateCardStyle}
                        />
                    ) : (
                        <ViralPostCard
                            post={card}
