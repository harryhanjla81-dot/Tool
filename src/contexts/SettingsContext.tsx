...
const INITIAL_CARD_STYLES: CardStyleSettings = {
  ...
  // New Summary settings
  summaryType: HeaderType.Solid,
  summarySolidColor: '#F9FAFB', // Default gray-50
  summaryGradientDirection: 'to right',
  summaryGradientColor1: '#FFFFFF',
  summaryGradientColor2: '#E5E7EB', // white to gray-200
};
